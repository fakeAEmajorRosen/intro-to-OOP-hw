...
public class Building {
    ...
    public boolean equals(Object newo) {
        ...
        if (!(newo instanceof Building)) {
            return false;
        }
        Building b = (Building) newo;
        return this.numFloors == b.numFloors && this.residential == b.residential
            && this.name.equals(b.name) && this.address.equals(b.address);
    }
