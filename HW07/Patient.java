...
public class Patient implements Comparable<Patient> {
    ...
    /**
     * This is a method that increase health.
     * @param h the value to increase health number
     */
    public void increaseHealth(HealAbility h) {
        this.health = this.health + h.getHealAmount();
        System.out.println("Patient " + this.name + " has been healed by " + h.getHealAmount() + " health points!");
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + this.patientID;
        return result;
    }
}